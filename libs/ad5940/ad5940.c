...
{  
  ...
  /*
  if(RegAddr != 0x00003004 && RegAddr != 0x00020000 && RegAddr != 0x00002000){ //&& RegAddr != 0x00002080
  printf("Writing Address: %08x, Writing Data: %08x\n", RegAddr, RegData);
  }
  */
  AD5940_CsClr();
...
{  
  ...
  /*
  if(RegAddr!=0x00003014 && RegAddr != 0x00002080 && RegAddr != 0x00002000){
    printf("Reading Address: %08x, Data %08x \n", RegAddr, Data);
  }
  */
  return Data;
}
...
//____________________________________________yes
...
AD5940Err AD5940_HSRtiaCal(HSRTIACal_Type *pCalCfg, void *pResult)
{
  ...
  *******************************/
  ...
  uint32_t const HSTIADERLOADTable[]={0,10,30,50,100,990000};
  uint32_t const HSTIADERTIATable[] = {50,100,200,1000,5000,10000,20000,40000,80000,160000,0,990000};
  uint32_t WgAmpWord;
